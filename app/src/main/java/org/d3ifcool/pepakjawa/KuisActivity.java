...
public class KuisActivity extends AppCompatActivity {
    ...
    private KuisBank mQuestionLibrary = new KuisBank(); // Penyimpanan Kuis
    private TextView mScoreView;   // Untuk menampilkan skor saat ini
    private TextView mQuestionView;  //menampilkan jawaban
    private Button mButtonChoice1; // Button jawaban 1
    private Button mButtonChoice2; // Button jawaban 2
    private Button mButtonChoice3; //Button jawaban 3
    private Button mButtonChoice4; //Button jawaban 4
